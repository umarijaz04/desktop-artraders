...
namespace AhmadSanitary
{
    public partial class Login : Form
    {
        ...
        public static SqlConnection con = new SqlConnection("server=localhost; database=Inventory; Integrated Security=True; Connect Timeout=180;");
        //public static SqlConnection con = new SqlConnection("server=CTC; database=Inventory; Integrated Security=True; Connect Timeout=180;");
