...
namespace AhmadSanitary
{
    public partial class Sales_Return : Form
    {
        ...
        private void entercartdata()
        {
            ...
            //                        {
            //                            dr5.Close();
            //                            MessageBox.Show("This Product Already Exist in Sales Return Cart", "AR Tranders", MessageBoxButtons.OK, MessageBoxIcon.Stop);
            //                        }
            //                        else
            //                        {
            //                            dr5.Close();
            ...
            //                else
            //                {
            //                    MessageBox.Show("Your Quantity Increases from Sales Invoice", "AR Tranders", MessageBoxButtons.OK, MessageBoxIcon.Question);
            //                }
            //            }
            //            else
            //            {
            //                dr.Close();
            //                MessageBox.Show("This Product is Not in the Sales Invoice", "AR Tranders", MessageBoxButtons.OK, MessageBoxIcon.Stop);
            //            }
            //        }
            //        else
            //        {
            //            MessageBox.Show("Please Enter Sales Invoice No", "AR Tranders", MessageBoxButtons.OK, MessageBoxIcon.Warning);
            //        }
            //        Login.con.Close();
            //    }
            //}
        ...
        //        else
        //        {
        //            MessageBox.Show("You Have Not Enough Quantity Against This Product Code in Sales Invoice", "AR Tranders", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
        //            String command = "select P_Code,Tone,Quality,Size,Boxes,Tiles,Meters,Price,Deduct,Amount from sr_cart";
        //            test.bindingcode(command, dataGridView, Login.con);
        //        }
        //        Login.con.Close();
        ...
        private void txtinvoice_Leave(object sender, EventArgs e)
        {
            if (txtinvoice.Text != "")
            {
                if (Convert.ToDecimal(txtinvoice.Text) != 0)
                {
                    ...
                    {
                        MessageBox.Show("Please Enter Correct Invoice No", "AR Tranders", MessageBoxButtons.OK, MessageBoxIcon.Stop);
                        dr.Close();
                        txtinvoice.Clear();
                        txtinvoice.Focus();
                        cmb = false;
            ...
            if (e.KeyCode == Keys.Enter)
            {
                if (txtsinvoice.Text != "")
                {
                    if (Convert.ToDecimal(txtsinvoice.Text) != 0)
                    {
                        ...
                        {
                            dr.Close();
                            MessageBox.Show("Sales Return No Already Exist", "AR Tranders", MessageBoxButtons.OK, MessageBoxIcon.Stop);
                            txtsinvoice.Clear();
                            txtsinvoice.Focus();
                            sinvoice = false;
                            btnsubmit.Enabled = false;
        ...
        private void btnsubmit_Click(object sender, EventArgs e)
        {
            ...
            //}
            Login.con.Close();
            DialogResult dresult = MessageBox.Show("Press 'OK' to Print SALES RETURN INVOICE", "AR Tranders", MessageBoxButtons.OKCancel, MessageBoxIcon.Question);
