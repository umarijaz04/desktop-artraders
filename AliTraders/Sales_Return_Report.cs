...
namespace AhmadSanitary
{
    public partial class Sales_Return_Report : Form
    {
        ...
        private void btndel_Click(object sender, EventArgs e)
        {
            if (delid != "")
            {
                DialogResult dresult = MessageBox.Show("Are you sure you want to delete this Sales Return No", "AR Tranders", MessageBoxButtons.OKCancel, MessageBoxIcon.Question);
                if (dresult == DialogResult.OK)
                {
                    ...
                    delid = "";
                    Login.con.Close();
                    MessageBox.Show("Sales Return Deleted Successfully", "AR Tranders", MessageBoxButtons.OK, MessageBoxIcon.Information);
